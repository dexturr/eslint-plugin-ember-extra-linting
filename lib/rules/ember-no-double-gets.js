...
module.exports = {
  ...
  create: function(context) {
    ...
    const calculateGetsForArguments = (node) => {
      ...
      const setExpressions = callExpressions.filter(node => node.callee.name === 'get');
    ...
    return {
      FunctionDeclaration(node) {
        ...
        const multipleSetsForArgument = calculateGetsForArguments(node);
