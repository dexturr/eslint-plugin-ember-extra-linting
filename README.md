...
`ember-no-pointlessgets`: Errors if trying to use the `get` function on the object without using the ability to check for properties. Infoms the user that property access is not preferred (since 3.1);
